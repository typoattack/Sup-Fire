...
public class missileTrigger_2_2 : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            bulletMove_2_2 bullet = other.GetComponent<bulletMove_2_2>();
        ...
        {
            MissileMove_2_2 missile = other.GetComponent<MissileMove_2_2>();
