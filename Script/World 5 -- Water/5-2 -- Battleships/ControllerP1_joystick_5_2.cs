...
/*
[System.Serializable]
public class Boundary1Stick_
{
    public float xMin, xMax, yMin, yMax, zMin, zMax;
}
*/
public class ControllerP1_joystick_5_2 : MonoBehaviour {
    ...
    public bulletMove_5_2 bullet;
    public MissileMove_5_2 missile;
    ...
    void FixedUpdate()
    {
        ...
        if (isFireing)
        {
            ...
            if (shotCounter <= 0)
            {
                ...
                {
                    special -= 1;
                    bulletMove_5_2 newBullet1 = Instantiate(bullet, firepoint.position, firepoint.rotation) as bulletMove_5_2;
                    bulletMove_5_2 newBullet2 = Instantiate(bullet, firepoint.position, firepoint.rotation) as bulletMove_5_2;
                ...
                else
                {
                    ...
                    {
                        special -= 1;
                        MissileMove_5_2 newMissile = Instantiate(missile, firepoint.position, firepoint.rotation) as MissileMove_5_2;
                    ...
                    {
                        bulletMove_5_2 newBullet = Instantiate(bullet, firepoint.position, firepoint.rotation) as bulletMove_5_2;
