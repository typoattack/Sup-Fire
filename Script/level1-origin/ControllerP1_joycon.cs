...
public class ControllerP1_joycon : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        float v_dir = Input.GetAxis("RightJoyCon-UD");
        float h_dir = Input.GetAxis("RightJoyCon-LR");
        ...
        float h_axis = Input.GetAxis("LeftJoyCon-LR");
        ...
        if (Input.GetAxis("JoyCon-Fire") > 0 && remainAmmo >= 1) //fire
